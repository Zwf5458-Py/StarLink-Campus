...
INSERT INTO `kg_class_board_config` (`id`, `class_id`, `board_mode`, `slogan`, `update_time`) VALUES
...
-- 小(1)班 (20人)
INSERT INTO `kg_student` (`id`, `class_id`, `name`, `gender`, `birthday`, `ic_card_no`, `allergies`, `guardian_name`, `guardian_phone`, `status`) VALUES
...
INSERT INTO `kg_student_attendance` (`student_id`, `class_id`, `attendance_date`, `check_in_time`, `check_in_type`, `check_in_temperature`, `status`) VALUES
...
INSERT INTO `kg_morning_check` (`student_id`, `check_date`, `temperature`, `is_fever`, `health_tags`, `remark`) VALUES
...
INSERT INTO `kg_patrol_point` (`id`, `point_name`, `location`, `device_type`, `sort_order`, `status`) VALUES
...
INSERT INTO `kg_patrol_record` (`patrol_point_name`, `patrol_staff_id`, `patrol_time`, `is_normal`, `abnormal_desc`) VALUES
...
INSERT INTO `kg_visitor_record` (`id`, `visitor_name`, `visitor_phone`, `visit_reason`, `visit_date`, `expected_arrival_time`, `status`, `overtime_alerted`, `create_time`) VALUES
...
INSERT INTO `kg_course` (`id`, `course_name`, `campus_name`, `target_grades`, `teacher_name`, `status`, `create_time`) VALUES
